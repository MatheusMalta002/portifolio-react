...
const Work = () => {
    ...
    return(
            <div name='work' className='w-full font-custom text-gray-800 xl:px-[180px] md:px-[150px] sm:px-[100px] xs:px-[50px] flex justify-center items-center py-14 '>
                <div className='max-w-[1000px] py-4 flex flex-col justify-center w-full h-full '>
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div key={index} className="imageProject shadow-md shadow-[#414142] group container rounded-md 
