            ...
            <div className='flex  justify-center items-center flex-col  pt-[75px] xs:pb-10  flex-shrink-0' data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="800">
                ...
                <div className='flex md:flex-row sm:flex-col-reverse xs:flex-col-reverse'>
                    <div className='flex font-custom flex-col items-start justify-center text-[#2c2c2b] xs:mt-3 sm:mt-14 md:mt-0'>
                        ...
                        whitespace-nowrap md:mb-4 sm:mb-4 xs:mb-5 font-bold'>
                            Matheus Malta
                        </h1>
                        ...
                        <p className='text-[#2c2b2c] font-medium whitespace-normal flex-shrink-0 xs:mb-5 sm:mb-5 md:mb-5 md:w-[75%] sm:w-[75%]'>
                            Currently, I'm focused on building responsive web applications.
                        </p>
                        <button className='btn_Contact ml-[3px] xs:w-full sm:w-auto'>
                            Contact me
                        </button>       
                    </div>
                    {/* IMAGEM */}
                    <div className='h-full w-full flex items-center justify-center md:ml-10 sm:ml-3 xs:ml-0'> 
                         <div className=' rounded-full sm:p-[10px] xs:p-[8px] bg-[#c6caff]'>
                            ...
                            sm:w-[220px] sm:h-[220px] xs:w-[220px] xs:h-[220px] transition-all rounded-full bg-[#9894cc] duration-500 sm:border-[10px] xs:border-[8px] border-[#acabec]
                            '>
                ...
                <div className='flex flex-col justify-center items-center w-full h-[130px]'>
                    ...
                    <p className='w-full text-center text-[10px] font-medium '>Scroll Down</p>
                    <div className='w-full flex justify-center'>
                    <IoIosArrowDown className=' animate-bounce text-[#2c2c2b] text-[10px] '/>
                    </div>
                    </div>
